        ...
        <div className="flex items-center justify-between text-xs gap-1.5 flex-wrap sm:flex-nowrap">
          ...
          <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
            ...
            <button
              type="button"
              onClick={togglePlay}
              className="p-1 sm:p-1.5 rounded-full bg-red-600 hover:bg-red-500 text-white shadow-md transition-colors focus:outline-none"
            ...
            <button
              ...
              className="px-1.5 sm:px-2 py-0.5 sm:py-1 rounded bg-red-600 hover:bg-red-500 text-white shadow-md transition-colors text-[9px] sm:text-[10px] font-mono flex items-center gap-0.5 focus:outline-none"
              title="Rewind 5s"
            >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 ml-auto sm:ml-0">
            ...
            <div className="flex items-center gap-1 sm:gap-1.5">
              <button
                type="button"
                onClick={toggleMute}
                className="p-1 sm:p-1.5 rounded bg-red-600 hover:bg-red-500 text-white shadow-md transition-colors focus:outline-none"
              ...
              <input
                ...
                className="hidden sm:block w-16 sm:w-20 h-1.5 bg-blue-950 border border-blue-800/40 rounded-lg appearance-none cursor-pointer accent-blue-500 focus:outline-none"
                title="Volume"
              />
            </div>
