...
import {
  ...
  RotateCcw, Leaf, ChevronLeft, ChevronRight
} from 'lucide-react';
              ...
              {open && (
                <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-slate-100 dark:divide-dark-600">
                  ...
                  <div className="p-4 flex flex-col justify-between h-full space-y-3">
                    <div className="space-y-3 flex-1">
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <span className="text-xs font-semibold text-indigo-500 uppercase tracking-wider">TAT · {tatCount} pics</span>
                        ...
                        {tatCount > 0 && (
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              className="px-2 py-1 rounded text-xs font-medium text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/10 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition-colors flex items-center gap-1"
                    ...
                    <div className="pt-2 mt-auto">
                      <button
                        ...
                        disabled={tatCount === 0}
                        className="w-full btn-primary flex items-center justify-center gap-1.5 text-xs disabled:opacity-40"
                      >
                  ...
                  <div className="p-4 flex flex-col justify-between h-full space-y-3">
                    <div className="space-y-3 flex-1">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-cyan-500 uppercase tracking-wider">WAT · {watCount} words</span>
                        {watCount > 0 && (
                          <div className="flex items-center gap-1">
                    ...
                    <div className="pt-2 mt-auto">
                      <button
                        ...
                        disabled={watCount === 0}
                        className="w-full bg-cyan-600 hover:bg-cyan-500 text-white font-semibold rounded-lg px-4 py-2 text-xs transition-colors flex items-center justify-center gap-1.5 disabled:opacity-40"
                      >
                  ...
                  {tatCount > 0 && watCount > 0 && (
                    <div className="p-4 sm:col-span-2 border-t border-slate-100 dark:border-dark-600">
                      <button
                        onClick={() => onStartTest('PSYCH', folder.dateFolder)}
                        className="w-full bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-lg px-4 py-2 text-xs transition-colors flex items-center justify-center gap-1.5"
                      >
